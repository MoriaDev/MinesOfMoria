 ...
 */
package com.temenoi.minesofmoria.actors.hero;
...
import com.temenoi.minesofmoria.Bones;
import com.temenoi.minesofmoria.Dungeon;
import com.temenoi.minesofmoria.GamesInProgress;
...
import com.temenoi.minesofmoria.actors.buffs.Barkskin;
import com.temenoi.minesofmoria.actors.buffs.Bleeding;
import com.temenoi.minesofmoria.actors.buffs.Blindness;
import com.temenoi.minesofmoria.actors.buffs.Buff;
import com.temenoi.minesofmoria.actors.buffs.Burning;
import com.temenoi.minesofmoria.actors.buffs.Combo;
import com.temenoi.minesofmoria.actors.buffs.Cripple;
import com.temenoi.minesofmoria.actors.buffs.Fury;
import com.temenoi.minesofmoria.actors.buffs.GasesImmunity;
import com.temenoi.minesofmoria.actors.buffs.Hunger;
import com.temenoi.minesofmoria.actors.buffs.Invisibility;
import com.temenoi.minesofmoria.actors.buffs.Light;
import com.temenoi.minesofmoria.actors.buffs.Ooze;
import com.temenoi.minesofmoria.actors.buffs.Paralysis;
import com.temenoi.minesofmoria.actors.buffs.Poison;
import com.temenoi.minesofmoria.actors.buffs.Regeneration;
import com.temenoi.minesofmoria.actors.buffs.Roots;
import com.temenoi.minesofmoria.actors.buffs.Charm;
import com.temenoi.minesofmoria.actors.buffs.SnipersMark;
import com.temenoi.minesofmoria.actors.buffs.Vertigo;
import com.temenoi.minesofmoria.actors.buffs.Weakness;
import com.temenoi.minesofmoria.actors.mobs.Mob;
import com.temenoi.minesofmoria.actors.mobs.npcs.NPC;
import com.temenoi.minesofmoria.effects.CheckedCell;
import com.temenoi.minesofmoria.effects.Flare;
import com.temenoi.minesofmoria.effects.Speck;
import com.temenoi.minesofmoria.items.Amulet;
import com.temenoi.minesofmoria.items.Ankh;
import com.temenoi.minesofmoria.items.DewVial;
import com.temenoi.minesofmoria.items.Dewdrop;
import com.temenoi.minesofmoria.items.Heap;
import com.temenoi.minesofmoria.items.Heap.Type;
import com.temenoi.minesofmoria.items.Item;
import com.temenoi.minesofmoria.items.KindOfWeapon;
import com.temenoi.minesofmoria.items.armor.Armor;
import com.temenoi.minesofmoria.items.keys.GoldenKey;
import com.temenoi.minesofmoria.items.keys.Key;
import com.temenoi.minesofmoria.items.keys.SkeletonKey;
import com.temenoi.minesofmoria.items.keys.IronKey;
import com.temenoi.minesofmoria.items.potions.Potion;
import com.temenoi.minesofmoria.items.potions.PotionOfMight;
import com.temenoi.minesofmoria.items.potions.PotionOfStrength;
import com.temenoi.minesofmoria.items.rings.RingOfAccuracy;
import com.temenoi.minesofmoria.items.rings.RingOfDetection;
import com.temenoi.minesofmoria.items.rings.RingOfElements;
import com.temenoi.minesofmoria.items.rings.RingOfEvasion;
import com.temenoi.minesofmoria.items.rings.RingOfHaste;
import com.temenoi.minesofmoria.items.rings.RingOfShadows;
import com.temenoi.minesofmoria.items.rings.RingOfThorns;
import com.temenoi.minesofmoria.items.scrolls.Scroll;
import com.temenoi.minesofmoria.items.scrolls.ScrollOfMagicMapping;
import com.temenoi.minesofmoria.items.scrolls.ScrollOfRecharging;
import com.temenoi.minesofmoria.items.scrolls.ScrollOfUpgrade;
import com.temenoi.minesofmoria.items.scrolls.ScrollOfEnchantment;
import com.temenoi.minesofmoria.items.wands.Wand;
import com.temenoi.minesofmoria.items.weapon.melee.MeleeWeapon;
import com.temenoi.minesofmoria.items.weapon.missiles.MissileWeapon;
import com.temenoi.minesofmoria.levels.Level;
import com.temenoi.minesofmoria.levels.Terrain;
import com.temenoi.minesofmoria.levels.features.AlchemyPot;
import com.temenoi.minesofmoria.levels.features.Chasm;
import com.temenoi.minesofmoria.levels.features.Sign;
import com.temenoi.minesofmoria.plants.Earthroot;
import com.temenoi.minesofmoria.scenes.GameScene;
import com.temenoi.minesofmoria.scenes.InterlevelScene;
import com.temenoi.minesofmoria.scenes.SurfaceScene;
import com.temenoi.minesofmoria.sprites.CharSprite;
import com.temenoi.minesofmoria.sprites.HeroSprite;
import com.temenoi.minesofmoria.ui.AttackIndicator;
import com.temenoi.minesofmoria.ui.BuffIndicator;
import com.temenoi.minesofmoria.utils.GLog;
import com.temenoi.minesofmoria.windows.WndMessage;
import com.temenoi.minesofmoria.windows.WndResurrect;
import com.temenoi.minesofmoria.windows.WndTradeItem;
