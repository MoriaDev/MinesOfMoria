...
import com.temenoi.minesofmoria.Rankings;
...
import com.temenoi.minesofmoria.windows.WndError;
import com.temenoi.minesofmoria.windows.WndRanking;
...
public class RankingsScene extends PixelScene {
	...
	public void create() {
		...
		if (Rankings.INSTANCE.records.size() > 0) {
			...
			float rowHeight = MinesOfMoria.landscape() ? ROW_HEIGHT_L : ROW_HEIGHT_P;
