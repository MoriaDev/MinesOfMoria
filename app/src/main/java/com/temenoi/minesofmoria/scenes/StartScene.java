...
import com.temenoi.noosa.BitmapText;
...
import com.temenoi.noosa.Image;
import com.temenoi.noosa.audio.Sample;
import com.temenoi.noosa.particles.BitmaskEmitter;
import com.temenoi.noosa.particles.Emitter;
import com.temenoi.noosa.ui.Button;
...
import com.temenoi.minesofmoria.effects.BannerSprites.Type;
import com.temenoi.minesofmoria.ui.Archs;
import com.temenoi.minesofmoria.ui.ExitButton;
import com.temenoi.minesofmoria.ui.Icons;
import com.temenoi.minesofmoria.ui.RedButton;
import com.temenoi.minesofmoria.utils.Utils;
import com.temenoi.minesofmoria.windows.WndChallenges;
import com.temenoi.minesofmoria.windows.WndClass;
import com.temenoi.minesofmoria.windows.WndMessage;
import com.temenoi.minesofmoria.windows.WndOptions;
...
public class StartScene extends PixelScene {
	...
	public void create() {
		...
		curClass = null;
		updateClass( HeroClass.values()[MinesOfMoria.lastClass()] );
		...
		Badges.loadingListener = new Callback() {
			...
			public void call() {
				if (Game.scene() == StartScene.this) {
					MinesOfMoria.switchNoFade( StartScene.class );
				}
			}
		};
	}
	...
	private void startNewGame() {
		...
		if (MinesOfMoria.intro()) {
			MinesOfMoria.intro( false );
	...
	protected void onBackPressed() {
		MinesOfMoria.switchNoFade( TitleScene.class );
	}
	...
	private class ChallengeButton extends Button {
		...
		protected void createChildren() {
			...
			image = Icons.get( MinesOfMoria.challenges() > 0 ? Icons.CHALLENGE_ON :Icons.CHALLENGE_OFF );
			add( image );
		}
		...
		protected void onClick() {
			if (Badges.isUnlocked( Badges.Badge.VICTORY )) {
				StartScene.this.add( new WndChallenges( MinesOfMoria.challenges(), true ) {
					public void onBackPressed() {
						super.onBackPressed();
						image.copy( Icons.get( MinesOfMoria.challenges() > 0 ? 
