...
import com.temenoi.minesofmoria.effects.BadgeBanner;
...
import com.temenoi.minesofmoria.windows.WndBadge;
...
public class BadgesScene extends PixelScene {
	...
	public void create() {
		...
		int pw = (int)Math.min( w, (MinesOfMoria.landscape() ? MIN_WIDTH_L : MIN_WIDTH_P) * 3 ) - 16;
		int ph = (int)Math.min( h, (MinesOfMoria.landscape() ? MIN_HEIGHT_L : MIN_HEIGHT_P) * 3 ) - 32;
